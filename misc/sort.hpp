...
namespace detail {
    ...
    struct TupleRadixSorter {
        ...
        static bool sort(It begin, It end, OutIt out_begin, OutIt out_end,
                         ExtractKey&& extract_key) {
            bool which =
                NextSorter::sort(begin, end, out_begin, out_end, extract_key);
    ...
    // function
    // 2. they help produce better error messages. with these overloads you get
    // the
    //    error message "no matching function for call to
    //    to_radix_sort(your_type)" without these examples, you'd get the error
    //    message "to_radix_sort_key was not declared in this scope" which is a
    //    much less useful error message
    ...
    struct PairSecondSubKey : Current {
        ...
        using next = typename std::conditional<
            ...
            SubKey<void>, PairSecondSubKey<F, S, typename Current::next>>::type;
    };
    template <typename F, typename S, typename Current>
    ...
    struct ListInplaceSorter {
        ...
        static void sort(It begin, It end, ExtractKey& extract_key,
            ...
            if (!StdSortIfLessThanThreshold<StdSortThreshold>(
                ...
                void (*sort_next_element)(It, It, std::ptrdiff_t, ExtractKey&,
                                          void*) =
                    static_cast<void (*)(It, It, std::ptrdiff_t, ExtractKey&,
