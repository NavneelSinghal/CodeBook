...
namespace subsetTransforms {
    template <typename T> // sum over subsets dp - for every index i, it finds the sum of all f(j) where j is a subset of i in binary
    ...
    template <typename T> //mobius dp - inclusion exclusion, inverse of zeta transform
