...
tuple<T, T, ll> find_all_solutions(T a, T b, T c, T minx, T maxx, T miny,
                                   T maxy) {
    ...
    T x, y, g;
    if (!find_any_sol(a, b, c, x, y, g)) return {0, 0, 0};
    a /= g;
    b /= g;
    c /= g;
